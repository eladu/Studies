...
#I've added error handling for UP and DOWN key strokes using input history tracking (readline). Each submenu now keeps track of the user's previous inputs.
